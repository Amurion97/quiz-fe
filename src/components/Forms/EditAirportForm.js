...
export default function EditAirportForm(props) {
    ...
    useEffect(() => {
        ...
        customAPIv1().get(`/airports/${props.currentUser}`)
            .then(res => {
                console.log("airports info:", res.data);
                setAirportInfo(res.data.data);
                setLoading(false)
            })
        ...
        <>
            {
                ...
                <Formik
                    ...
                    onSubmit={(values, {setSubmitting, resetForm}) => {
                        ...
                        // try {
                        customAPIv1().put(`/airports/${props.currentUser}`, values)
                            .then((response) => {
                                console.log("Edit airport success");
                                setSubmitting(false);
                                setOpen(false);
                                setOpenSuccess(true);
                                props.updateUsers();
