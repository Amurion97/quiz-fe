...
export const fetchFlight = createAsyncThunk(
    ...
    async (arg, thunkAPI) => {
        console.log("arg:", arg)
        const response = await customAPIv1().get(`flights/${arg.id}`)
...
export const seatChoosingSlice = createSlice({
    name: 'flight',
    initialState,
...
export const {increment, decrement, incrementByAmount} = seatChoosingSlice.actions;
...
const flightReducer = seatChoosingSlice.reducer
